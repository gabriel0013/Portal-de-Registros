...
export const EyeIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639l4.43-6.112a.998.998 0 0 1 1.513-.01L12 11.63l3.021-4.42a.998.998 0 0 1 1.513.01l4.43 6.112a1.012 1.012 0 0 1 0 .639l-4.43 6.112a.998.998 0 0 1-1.513.01L12 12.37l-3.021 4.42a.998.998 0 0 1-1.513-.01l-4.43-6.112Z" />
    </svg>
);
